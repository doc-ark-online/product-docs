...
{ text: '服饰上架&售卖', link: '/CreatorPortal/Clothespublish&sales.md' }
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: 'v0.44.0.0', link: '/ReleaseNote/v0.40.0.0.md' },
          { text: 'v0.43.0.3', link: '/ReleaseNote/v0.43.0.3.md' },
          { text: 'v0.43.0.2', link: '/ReleaseNote/v0.43.0.2.md' },
          { text: 'v0.43.0.1', link: '/ReleaseNote/v0.43.0.1.md' },
          { text: 'v0.43.0.0', link: '/ReleaseNote/v0.43.0.0.md' },
          { text: 'v0.42.0.2', link: '/ReleaseNote/v0.42.0.2.md' },
          { text: 'v0.42.0.1', link: '/ReleaseNote/v0.42.0.1.md' },
          { text: 'v0.42.0.0', link: '/ReleaseNote/v0.42.0.0.md' },
          { text: 'v0.41.0.6', link: '/ReleaseNote/v0.41.0.6.md' },
          { text: 'v0.41.0.5', link: '/ReleaseNote/v0.41.0.5.md' },
          { text: 'v0.41.0.4', link: '/ReleaseNote/v0.41.0.4.md' },
          { text: 'v0.41.0.3', link: '/ReleaseNote/v0.41.0.3.md' },
          { text: 'v0.41.0.2', link: '/ReleaseNote/v0.41.0.2.md' },
          { text: 'v0.41.0.1', link: '/ReleaseNote/v0.41.0.1.md' },
          { text: 'v0.41.0.0', link: '/ReleaseNote/v0.41.0.0.md' },
